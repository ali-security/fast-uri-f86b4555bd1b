...
test('decoded schemes select their scheme handlers', (t) => {
  ...
  // The reference asserts this against the mailto handler, which this version
  // does not register. urn:uuid exercises the same property: the handler is
  // only reached when the scheme is decoded before the lookup.
  const urnuuid = fastURI.parse('%75rn:uuid:b571b0bc-4713-11ec-81d3-0242ac130003')
  ...
  t.equal(urnuuid.uuid, 'b571b0bc-4713-11ec-81d3-0242ac130003', 'urn:uuid handler ran after decoding the scheme')
  t.end()
})
